...
var FournisseurFactureApi = /** @class */ (function () {
    function FournisseurFactureApi() {
    }
    FournisseurFactureApi.prototype.getFactures = function (url) {
        return axiosModule_1["default"].instance
            .get(url ? "api/fournisseur_facture" + url : "api/fournisseur_facture")
            .then(function (x) { return x.data; });
    };
    FournisseurFactureApi.prototype.saveFacture = function (facture) {
    ...
    FournisseurFactureApi.prototype.deleteFacture = function (id) {
        var deletedFacture = axiosModule_1["default"].instance["delete"]("api/fournisseur_facture/" + id)
            .then(function (x) { return x.data; });
    ...
    return FournisseurFactureApi;
}());
exports["default"] = FournisseurFactureApi;
