...
function (_super) {
  ...
  ExportModule.prototype.deleteImportExportFacture = function (id) {
    return __awaiter(this, void 0, Promise, function () {
      return __generator(this, function (_a) {
        return [2
        /*return*/
        , this.apiExportImport.deleteExportImport(id)];
      });
    });
  }; // get getClient() {
  ...
  ExportModule.prototype.addItem = function (sale) {
    ...
    var index = this.facture.transfers.findIndex(function (e) {
      return e.product_id == productNew.product_id;
    });
    if (index >= 0) this.facture.transfers[index].quantity = this.facture.transfers[index].quantity + 1;else this.facture.transfers.push(productNew);
  }; // @Mutation
  ...
  ExportModule.prototype.deleteSale = function (id) {
    return saleApi_1["default"].deleteSale(id).then(function (x) {
      return x;
    });
  };

  __decorate([vuex_class_modules_1.Mutation], ExportModule.prototype, "setFacture");

  __decorate([vuex_class_modules_1.Mutation], ExportModule.prototype, "addItem");

  __decorate([vuex_class_modules_1.Mutation], ExportModule.prototype, "clearCart");

  ExportModule = __decorate([vuex_class_modules_1.Module({
