...
exports.getHardDiskSerialNumber = void 0;
...
function getHardDiskSerialNumber() {
    return __awaiter(this, void 0, void 0, function () {
        var disks, firstDisk, serialNumber, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, systeminformation_1["default"].diskLayout()];
                case 1:
                    disks = _a.sent();
                    if (disks.length > 0) {
                        firstDisk = disks[0];
                        serialNumber = firstDisk.serialNum;
                        console.log("Hard Disk Serial Number:", serialNumber);
                        return [2 /*return*/, serialNumber];
                    }
                    else {
...
exports.getHardDiskSerialNumber = getHardDiskSerialNumber;
